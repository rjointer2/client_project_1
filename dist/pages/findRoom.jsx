...
function FindRoom() {
    ...
    const eventHandler = (e) => {
        ...
        if (name == "scoreLimit" && isNaN(parseInt(value))) {
            console.log(value);
            setLocalState(s => {
                return Object.assign(Object.assign({}, s), { scoreIsInValid: true });
            });
            return;
        }
        setLocalState(s => { return Object.assign(Object.assign({}, s), { [name]: value, scoreIsInValid: false }); });
    };
    return (<div style={{ paddingTop: '30vh' }}>
      <react_bootstrap_1.Form onSubmit={submitHandler}>

          <react_bootstrap_1.Form.Group className="mb-3">
              <react_bootstrap_1.Form.Label>Find a Room Name</react_bootstrap_1.Form.Label>
